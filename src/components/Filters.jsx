	...
	return(
		<div className='w-full h-12 border-2 border-gray-100 rounded-lg flex items-center justify-between relative'>
			...
			<div className='flex mr-7'>
				<form className='relative mr-12 flex items-center font-nunito' 
					>
					...
					<button className='ml-1 cursor-pointer' type='submit' onClick={handleCurrencySubmit}>
				...
				<img src={selectIcon} alt='select' className='w-[1rem] absolute right-1 top-2 pointer h-auto pointer-events-none'/>
			</label>
			<button onClick={resetFunc} className='w-[2rem] ml-4 hover:scale-110 transition-all transition-ease relative'>
			 <svg
