...
const HighLowIndicator = ({ currentPrice, high, low }) => {
    ...
    return (
        // <>
        //     <span className='bg-red h-1.5 rounded-l-lg' style={{width:`${100-green}%`}}>&nbsp;</span>
        //     <span className='bg-green h-1.5 rounded-l-lg' style={{width:`${green}%`}}>&nbsp;</span>
        // </>
        <div className="w-full bg-green h-1.5 rounded-lg">
            <div className="w-full bg-red h-full rounded-lg" style={{
                width: (100 - green) + '%'
            }} />
        </div>
    )
...
export default function CryptoDetails() {
    ...
    return ReactDOM.createPortal(
        <div className='fixed top-0 w-full h-full bg-gray-200 bg-opacity-30 backdrop-blur-sm flex items-center justify-center font-nunito' onClick={close}>
                ...
                {coinData ?
                    <div className='flex items-center justify-between h-full w-full p-4'>
                        <div className='flex flex-col w-[45%] h-full pr-2'>
                            ...
                            <div className='flex w-full mt-6'>
                                <div className='flex w-full flex-col'>
                                    <div className='flex justify-between'>
                                        ...
                                        <div className={`text-sm px-1 font-medium flex items-center ml-2 rounded uppercase bg-opacity-25
                                            ${coinData.market_data.market_cap_change_percentage_24h > 0 ? 'bg-green text-green' : 'bg-red text-red'}`
                                        }>
                                            <span>
                                                {Number(coinData.market_data.market_cap_change_percentage_24h).toFixed(2)}%
                                            </span>
                                            <svg className={`w-[1rem] mx-1 ${coinData.market_data.market_cap_change_percentage_24h > 0 ? 'fill-green rotate-180' : 'fill-red'}`} width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className='flex justify-between mt-4 w-full'>
                                <div className='flex flex-col'>
                                    <a target={'blank'} rel={'noreferrer'} className='text-sm bg-gray-200 my-1 px-1.5 rounded-lg text-gray-100 py-1' href={coinData?.links?.homepage[0]}>{coinData?.links?.homepage[0].substring(0, 30)}</a>
                                    <a target={'blank'} rel={'noreferrer'} className='text-sm my-1 bg-gray-200 px-1.5 rounded-lg text-gray-100 py-1' href={coinData?.links?.blockchain_site[0]}>{coinData?.links?.blockchain_site[0].substring(0, 30)}</a>
                                    {
                                        coinData?.links?.official_forum_url[0] && <a target={'blank'} rel={'noreferrer'} className='text-sm bg-gray-200 px-1.5 rounded-lg text-gray-100 py-1' href={coinData?.links?.official_forum_url[0]}>{coinData?.links?.official_forum_url[0].substring(0, 30)}</a>
                                    }
                                </div>
                                <div className='flex flex-col content-start'>
                                    <span className='capitalize text-sm text-gray-100'>sentiment</span>
                                    <div className='flex justify-between'>
                                        <div className='text-sm px-1 font-medium my-1 flex items-center ml-1 rounded uppercase bg-opacity-25 bg-green text-green'>
                                            <span>
                                                {Number(coinData.sentiment_votes_up_percentage).toFixed(2)}%
                                            </span>
                                            <svg className='w-[1rem] rotate-180' width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M7.47951 11.4153C7.42599 11.493 7.35438 11.5565 7.27085 11.6004C7.18732 11.6444 7.09437 11.6673 7.00001 11.6673C6.90564 11.6673 6.81269 11.6444 6.72916 11.6004C6.64563 11.5565 6.57402 11.493 6.52051 11.4153L1.27051 3.83194C1.20974 3.74447 1.1741 3.64202 1.16747 3.53572C1.16084 3.42943 1.18346 3.32334 1.23289 3.229C1.28232 3.13466 1.35665 3.05567 1.44782 3.0006C1.53899 2.94554 1.6435 2.91652 1.75001 2.91669H12.25C12.3563 2.91713 12.4604 2.94652 12.5512 3.00172C12.642 3.05691 12.716 3.13581 12.7653 3.22993C12.8147 3.32406 12.8374 3.42984 12.8311 3.53591C12.8247 3.64199 12.7896 3.74433 12.7295 3.83194L7.47951 11.4153Z" fill='green' />
                                            </svg>
                                        </div>
                                    </div>

                                    <div className='flex justify-between'>
                                        <div className='text-sm px-1 font-medium flex items-center my-1 ml-1 rounded uppercase bg-opacity-25 bg-red text-red'>
                                            <span>
                                                {Number(coinData.sentiment_votes_down_percentage).toFixed(2)}%
                                            </span>
                                            <svg className='w-[1rem]' width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M7.47951 11.4153C7.42599 11.493 7.35438 11.5565 7.27085 11.6004C7.18732 11.6444 7.09437 11.6673 7.00001 11.6673C6.90564 11.6673 6.81269 11.6444 6.72916 11.6004C6.64563 11.5565 6.57402 11.493 6.52051 11.4153L1.27051 3.83194C1.20974 3.74447 1.1741 3.64202 1.16747 3.53572C1.16084 3.42943 1.18346 3.32334 1.23289 3.229C1.28232 3.13466 1.35665 3.05567 1.44782 3.0006C1.53899 2.94554 1.6435 2.91652 1.75001 2.91669H12.25C12.3563 2.91713 12.4604 2.94652 12.5512 3.00172C12.642 3.05691 12.716 3.13581 12.7653 3.22993C12.8147 3.32406 12.8374 3.42984 12.8311 3.53591C12.8247 3.64199 12.7896 3.74433 12.7295 3.83194L7.47951 11.4153Z" fill='red' />
                                            </svg>
                        ...
                        <div className='flex flex-col items-center w-[55%] h-full pl-3'>
                            <Chart id={coinId} />
                        ...
                        <div className='absolute flex items-center bottom-8 right-8'>
                            {coinData.links.repos_url.github[0] && <a className='text-lg px-1' target={'blank'} rel='noreferrer' href={coinData.links.repos_url.github[0]}>
                                <svg
                            ...
                            {coinData.links.twitter_screen_name && <a className='text-lg px-1' target={'blank'} rel='noreferrer' href={`http://twitter.com/${coinData.links.twitter_screen_name}`}>
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="1em"
                                    height="1em"
                            ...
                            {coinData.links.subreddit_url && <a className='text-lg px-1' target={'blank'} rel='noreferrer' href={coinData.links.subreddit_url}>
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="1em"
                                    height="1em"
                            ...
                            {coinData.links.facebook_username && <a className='text-lg px-1' target={'blank'} rel='noreferrer' href={`http://facebook.com/${coinData.links.facebook_username}`}>
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="1em"
                                    height="1em"
