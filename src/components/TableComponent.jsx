      ...
      <div className='flex flex-col mt-9 border border-gray-100 rounded'>
        {cryptoData ?
         <table className='w-full table-auto'>
          <thead className='capitalize text-base text-gray-100 border-b border-gray-100 font-medium'>
            <tr>
              ...
              cryptoData.map(data => 
              {
                return <tr
                    ...
                    <SaveBtn data={data}/>
                      ...
                      <span><Link to={`/${data.id}`} className='cursor-pointer'>
                        {data.symbol}
                      </Link></span>
                    </td>
                    <td className='py-4'>
         ...
         </table> : <div className='w-full min-h-[80vh] flex justify-center items-center'>
              <div className='w-8 h-8 border-4 border-cyan rounded-full border-b-gray-100 animate-spin' role='status'/><span className='ml-2'>Please Wait...</span>
               </div>
        }
      </div>
      <div className='flex items-center justify-between mt-4 capitalize h-[2rem]'>
        <span>Data provided by <a target={'blank'} className='text-cyan' rel='norefferer' href="https://www.coingecko.com/en/api/documentation">CoinGecko</a></span>
        <Pagination />
      </div>
    </>  
  )
