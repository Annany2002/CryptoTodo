...
export default function Saved() {
    ...
    return (
        <section className='w-[80%] h-full flex flex-col mt-16 mb-24 relative'>
            <div className='w-full pt-8 border border-gray-100 rounded'>
                {
                    savedData ?
                    <table className='w-full table-auto'>
                        ...
                        <tbody>
                            ...
                            <span className='text-xl text-cyan font-medium font-nunito'>No Saved Coin</span>
                         </div>

                }
                <button onClick={resetSavedData} className='w-[2rem] ml-4 hover:scale-110 transition-all transition-ease absolute right-0 -top-10'>
                    <svg
